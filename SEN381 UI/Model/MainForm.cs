...
namespace MatthiWare.SmsAndCallClient
{
    ...
    public partial class MainForm : Form
    {
        ...
        {
            m_currentApi = cbApis.SelectedItem as IPerson;
        ...
        public async void btnText_Click(object sender, EventArgs e)
        {
            btnText.Enabled = false;
            //AssignJob assignJobForm = new AssignJob();
            //assignJobForm.ShowDialog();
            //string recipient = assignJobForm.To;
            //string message = assignJobForm.Body;

            string from = "+12705139932";
        ...
        public async void btnCall_Click(object sender, EventArgs e)
        {
